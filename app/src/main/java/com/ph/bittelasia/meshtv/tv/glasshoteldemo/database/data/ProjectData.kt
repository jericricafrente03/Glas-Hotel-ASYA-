...
class ProjectData {
    fun getAmenities(): List<AmenitiesItem> {
        ...
        amenities.add(
            AmenitiesItem(
                "BREAKFAST",
                "amenities",
                "amenities for pullman hotel and resorts",
                true,
                1,
    ...
    fun getMainUi(): List<MainUi> {
        ...
        ui.add(
            MainUi(
                4,
                "android.resource://com.ph.bittelasia.meshtv.tv.glasshoteldemo/drawable/icon4",
                "AIRMEDIA",
                true
            )
        )
    ...
    fun getAirmedia(): List<AirmediaItem> {
        val airmedia = ArrayList<AirmediaItem>()
        airmedia.add(
            AirmediaItem(
                "ANDROID",
                "amenities",
                ...
                true,
                1,
                "android.resource://com.ph.bittelasia.meshtv.tv.glasshoteldemo/drawable/android",
                "logo for amenities"
            )
        )
        airmedia.add(
            AirmediaItem(
                ...
                true,
                2,
                "android.resource://com.ph.bittelasia.meshtv.tv.glasshoteldemo/drawable/ios",
                "logo for amenities"
            )
        )
        airmedia.add(
            AirmediaItem(
                ...
                true,
                3,
                "android.resource://com.ph.bittelasia.meshtv.tv.glasshoteldemo/drawable/windows",
                "logo for amenities"
            )
        )
